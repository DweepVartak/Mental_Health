            ...
            <div class="option-container">
                <div class="answer-option">
                    <input type="radio" id="question_${
                      currentQuestion + 1
                    }_option_1" name="question_${
      currentQuestion + 1
    }" value="0" onchange="saveAnswer(this)">
                ...
                <div class="answer-option">
                    <input type="radio" id="question_${
                      currentQuestion + 1
                    }_option_2" name="question_${
      currentQuestion + 1
    }" value="1" onchange="saveAnswer(this)">
                ...
                <div class="answer-option">
                    <input type="radio" id="question_${
                      currentQuestion + 1
                    }_option_3" name="question_${
      currentQuestion + 1
    }" value="2" onchange="saveAnswer(this)">
                ...
                <div class="answer-option">
                    <input type="radio" id="question_${
                      currentQuestion + 1
                    }_option_4" name="question_${
      currentQuestion + 1
    }" value="3" onchange="saveAnswer(this)">
                ...
                <div class="answer-option">
                    <input type="radio" id="question_${
                      currentQuestion + 1
                    }_option_5" name="question_${
      currentQuestion + 1
    }" value="4" onchange="saveAnswer(this)">
